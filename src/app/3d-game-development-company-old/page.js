  ...
  const severcedata = [
    {
      ...
      serdata: [
        ...
        },
        {
          ...
          text: "Appsters offers world-class solutions for both web and mobile platforms. We specialized in creating stunning 3D apps with modern technologies such as Augmented Reality, Virtual Reality, 3D Modeling and Animation, WebGL, HTML5/CSS3, etc.",
          appclass: "app2",
        ...
        },
        {
          ...
          text: "Appsters recognizes that the game development journey doesn't end with its launch. That's why we provide our clients with comprehensive support and maintenance services to ensure their games remain attractive, immersive, and up-to-date with the latest trends.",
          appclass: "app5",
  ...
  return (
    <>
      ...
      <ServiceEngage
        ...
        text1="Appsters celebrates a team of experienced game developers and designers with the necessary skills and knowledge to create engaging, highly-converting 3D games. Our developers always keep an eye on innovation and creativity."
        engIcon1={engIcon1}
        heading2="Quality Graphics"
        text2="Appsters is committed to providing its clients with high-quality 3D graphics that capture the attention of players, making the gaming experience even more immersive."
        engIcon2={engIcon2}
        heading3="Cutting Edge Technology"
        text3="The developers at Appsters are always looking to stay ahead of the curve when it comes to using innovative technology in their 3D games. They utilize the latest technologies and tools to ensure top-quality 3D games with immersive graphics, engaging gameplay, and high performance."
        engIcon3={engIcon3}
        heading4="Quality Assurance"
        text4="Appsters employs a rigorous quality assurance process to ensure that every game created meets the highest standards of excellence. This helps to guarantee an exciting and bug-free gaming experience for all players."
        engIcon4={engIcon4}
      />
      <Newsuccess
        assignClass="spacing"
        ...
        {`
                    {
                      ...
                      "url": "https://www.Appsters.co/3d-game-development-company",
                      "potentialAction": {
                        "@type": "SearchAction",
        ...
        {`
                    {
                      ...
                      "@type": "LocalBusiness",
                      "name": "3D Games Development Company",
                      "image": "https://www.Appsters.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FbannerImage.6e414021.png&w=1920&q=75",
                      "url": "https://www.Appsters.co/3d-game-development-company",
