...
import { ArrowIcon, EmailIcon, PhoneIcon, PHONE_NUMBER, EMAIL_ADDRESS } from '@/src/app/app-constants'
...
const LocationList = [
    {
        ...
        phone: "+1 855 799 1171",
        email: "support@appsters.io",
        img: Houston.src,
...
const Location = ({ bg }) => {
    ...
    return (
        <section className={`${styles.locationSection} ${bg ? bg : 'bgBlack'} pt-100`}>
            <Container>
                <Row>
                    <Col lg={12} md={12}>
