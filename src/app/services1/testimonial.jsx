                ...
                <Row>
                    ...
                    <Col lg={7} md={6}>
                        <div className={styles.reviewsBox}>
                            <Image src={IMG01} alt="Appsters Reviews" width={145} height={65} />
                            <Image src={IMG02} alt="Appsters Reviews" width={145} height={65} />
                            <Image src={IMG03} alt="Appsters Reviews" width={145} height={65} />
                        </div>
                    </Col>
                </Row>
                <Row>
