...
export const RisksContent = {
    title: (<>Launch Your <Image src={RisksIMG01} alt="Appsters Services" width={228} height={85} /> Cross-Platform App with a  Strategic <Image src={RisksIMG02} alt="Appsters Services" width={228} height={85} /> MVP Approach!</>),
...
export const TechStackContent = {
    ...
    text: "At Appsters, we use a refined tech stack to deliver high-performing cross-platform apps. ",
}
