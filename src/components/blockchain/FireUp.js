                                    ...
                                    <Row className='pt-4'>
                                        <Col lg={6}>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <p className='mt-4'> <a className='text-white' href="tel:8557991171">+1 855 799 1171</a></p>
                                                <p><a className='text-white' href="tel:8557991171">+1 855 799 1171</a></p>
                                            </div>
                                            <div className='mb-4'>
                                    ...
                                    <Row className='pt-4'>
                                        <Col lg={6}>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <p><a className='text-white' href="8557991171">+92 855 799 1171</a></p>
                                            </div>
