                        ...
                        <Slider {...awardslogo} className={` ${styles.nextalign1} prohome mt-4 mb-4`}>
                            <div className={styles.high}>
                                <Row>
                                    <Col xl={6}>
                                        ...
                                        <div className={styles.deter}>
                                            ...
                                            <p className={styles.cen}>
                                                <Image quality={75} alt='Appsters' src={close} className='img-fluid' />
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            <Image quality={75} alt='Appsters' src={team1} className={` ${styles.imgpon} img-fluid`} />
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                            <div className={styles.high}>
                                <Row>
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            <Image quality={75} alt='Appsters' src={team2} className={` ${styles.imgpon} img-fluid`} />
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                            <div className={styles.high}>
                                <Row>
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            <Image quality={75} alt='Appsters' src={team3} className={` ${styles.imgpon} img-fluid`} />
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                            ...
                            <div className={styles.high}>
                                <Row>
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            <Image quality={75} alt='Appsters' src={team4} className={` ${styles.imgpon} img-fluid`} />
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                            <div className={styles.high}>
                                <Row>
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            <Image quality={75} alt='Appsters' src={team5} className={` ${styles.imgpon} img-fluid`} />
                                        </div>
                                    </Col>
                                </Row>
                            </div>
                            <div className={styles.high}>
                                <Row>
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            <Image quality={75} alt='Appsters' src={team6} className={` ${styles.imgpon} img-fluid`} />
                                        </div>
                                    </Col>
                                </Row>
                            </div>
