...
import Appsterspopup from "@/src/components/Appsterspopup";
// images
                                        ...
                                        <Col lg={4} className={`${styles.newset}`}>
                                            <div className={styles.lptow}>
                                                ...
                                                <div className={styles.proper}>
                                                    <h4 className="manrope">Development Excellence with Appsters</h4>
                                                    <h3>
                                                        On Time, Within Budget
                                                    </h3>
                                                    <p>
                                                        At Appsters, we bridge your ideas with the real world, turning visions into vivid experiences. Innovation drives us, whether it's through mobile apps or blockchain technology, and we're committed to keeping you ahead. Our deep understanding of technology isn't just our craft; it's our passion, powering every unique solution we create for you. At Appsters, we don't just build solutions; we craft a future where our success is intertwined with yours.
                                                    </p>
                                                </div>
                                    ...
                                    <Row className="gy-4">
                                        ...
                                        <Col lg={4} className={`${styles.newset}`}>
                                            <div className={`${styles.lptow} ${styles.lptow2}`}>
                                                ...
                                                <div className={styles.proper}>
                                                    <h4 className="manrope">Crafting Success with Appsters</h4>
                                                    <h3>
