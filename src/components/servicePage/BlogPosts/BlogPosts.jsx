            ...
            <Container>
                <Row>
                    ...
                    <Col md={6} lg={4} className='p-2'>
                        <div className={styles.card}>
                            <div className={styles.cardImg}>
                                <Image src={BlogImage1} alt='Appsters' className='img-fluid w-100' />
                            </div>
                            <div className={styles.cardContent}>
                                <p className='fontsfregular manrope font-regular'>Blockchain</p>
                                <h5 className='fontsfregular manrope'>Conquer Tech With Appsters: <br />
                                    Your Path To Unstoppable Progress!</h5>
                                <p className='fontsfregular manrope font-regular'>Appsters' Development Of The Proeye Project, A Wallet Analytics And Search Engine Platform On Blockchain,  Their Comprehensive Work, From Requirement Analysis</p>
                            ...
                            <div className={styles.cardBottom}>
                                ...
                                <div className={styles.cardbottomContent}>
                                    ...
                                    <p className='fontsfregular manrope font-regular'>Appsters' Development Of The Proeye Project, A Wallet Analytics And Search Engine Platform On Blockchain, </p>
                                </div>
                            </div>
                        </div>
                    </Col>
                    <Col md={6} lg={4} className='p-2'>
                        <div className={styles.card}>
                            <div className={styles.cardImg}>
                                <Image src={BlogImage2} alt='Appsters' className='img-fluid w-100' />
                            </div>
                            <div className={styles.cardContent}>
                    ...
                    <Col lg={4} className='p-2'>
                        <div className={styles.card}>
                            <div className={styles.cardImg}>
                                <Image src={BlogImage3} alt='Appsters' className='img-fluid w-100' />
                            </div>
                            <div className={styles.cardContent}>
