                    ...
                    <Row>
                        <Col xl={12}>
                            ...
                            <Slider {...awardslogo} className={` ${styles.nextalign1} prohome mt-4 mb-4`}>
                                ...
                                <div className={styles.high}>
                                    <p className='mt-3 mb-3'> Appsters have done a great job making an attractive and eye-catching IOS application. I am grateful to the team for delivering this application perfectly on very short notice. Thanks a lot.</p>
                                    <h3>Andrew Drake</h3>
