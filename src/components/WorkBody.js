                    ...
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio1} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.estate}`}>
                <Container>
                    <Row className={`align-items-center gy-4`}>
                        ...
                        <Col lg={6}>
                            <div className={`${styles.workImg}`}>
                                <Image quality={75} src={ourportfolio2} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.ecommerce}`}>
                <Container>
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio3} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.scribe}`}>
                <Container>
                    <Row className={`align-items-center gy-4`}>
                        ...
                        <Col lg={6}>
                            <div className={`${styles.workImg}`}>
                                <Image quality={75} src={ourportfolio4} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.grease}`}>
                <Container>
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio5} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
                    ...
                    <Row className={`align-items-center gy-4`}>
                        ...
                        <Col lg={6}>
                            <div className={`${styles.workImg} ${styles.workImg3}`}>
                                <Image quality={75} src={ourportfolio6} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.health}`}>
                <Container>
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio7} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.ride}`}>
                <Container>
                    <Row className={`align-items-center gy-4`}>
                        ...
                        <Col lg={6}>
                            <div className={`${styles.workImg}`}>
                                <Image quality={75} src={ourportfolio8} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.fit}`}>
                <Container>
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio9} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.ready}`}>
                <Container>
                    <Row className={`align-items-center gy-4`}>
                        ...
                        <Col lg={6}>
                            <div className={`${styles.workImg}`}>
                                <Image quality={75} src={ourportfolio10} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.crave}`}>
                <Container>
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio11} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.home}`}>
                <Container>
                    <Row className={`align-items-center gy-4`}>
                        ...
                        <Col lg={6}>
                            <div className={`${styles.workImg}`}>
                                <Image quality={75} src={ourportfolio12} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
            ...
            <section className={`${styles.workBg} ${styles.beats}`}>
                <Container>
                    <Row className='align-items-center gy-4'>
                        ...
                        <Col lg={6}>
                            <div className={styles.workImg}>
                                <Image quality={75} src={ourportfolio13} alt='Appsters' className='img-fluid' />
                            </div>
                        </Col>
                    </Row>
                </Container>
