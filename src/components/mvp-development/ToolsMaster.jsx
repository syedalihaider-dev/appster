    ...
    const tabs = [
        {
            ...
            img: '/mvp-development/mobile.webp'
        },
        {
            id: 'FullStack',
            ...
            img: '/mvp-development/full-stack.webp'
        },
        {
            id: 'Database',
            label: 'Database',
            ...
            img: '/mvp-development/database.webp'
        },
        {
            id: 'Backend',
            label: 'Backend',
            ...
            img: '/mvp-development/backend.webp'
        },
        {
            id: 'Blockchain',
            label: 'Blockchain',
            ...
            img: '/mvp-development/blockchain.webp'
        }
    ];
                        ...
                        <div className="col-lg-7">
                            <h2 className={styles.title}>
                                Dynamics & Stacks For <span className={styles.highlight}>Performance.
                                    <Image src="/mvp-development/spring-vector.webp" width={424} height={22} alt="Spring Vector" className={styles.springVector} />
                                </span>
                            </h2>
