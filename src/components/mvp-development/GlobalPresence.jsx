                ...
                <div className={styles.topHeader}>
                    <div className={styles.navArrows}>
                        <button className={styles.arrowBtn} onClick={() => sliderRef.current.slickPrev()}>
                            <Image src="/mvp-development/arrow.webp" alt="prev" width={25} height={31} className={styles.prevIcon} />
                        </button>
                        <button className={styles.arrowBtn} onClick={() => sliderRef.current.slickNext()}>
                            <Image src="/mvp-development/arrow.webp" alt="next" width={25} height={31} className={styles.nextIcon} />
                        </button>
                    </div>
                    <h2 className={styles.title}>
                        Our Global <span className={styles.highlight}>
                            Presence
                            <Image src="/mvp-development/spring-vector.webp" alt="line" width={250} height={15} className={styles.spring} />
                        </span>
                    </h2>
                </div>
                            ...
                            <div key={index} className={styles.cardItem}>
                                <div className={styles.locationCard}>
                                    <div className={styles.imageOverlay}>
                                        <Image src={`/mvp-development/${loc.img}`} alt={loc.city} fill className={styles.cityImg} />
                                        <h3 className={styles.cityName}>{loc.city}</h3>
                                    </div>
                                    <div className={styles.cardContent}>
                                        <div className={styles.infoRow}>
                                            <Image src="/mvp-development/map.webp" alt="map" width={24} height={24} className={styles.icon} />
                                        ...
                                        <div className={styles.infoRow}>
                                            <Image src="/mvp-development/phone.webp" alt="phone" width={21} height={28} className={styles.icon} />
                                            <div className={styles.details}>
                                        ...
                                        <div className={styles.infoRow}>
                                            <Image src="/mvp-development/email.webp" alt="email" width={20} height={16} className={styles.icon} />
                                            <div className={styles.details}>
