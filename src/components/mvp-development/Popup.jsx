                    ...
                    <div className={`col-md-6 col-lg-6 ${styles.leftCol}`}>
                        <div className={styles.contentBox}>
                            ...
                            <div className={styles.clutchBox}>
                                <Image src="/mvp-development/popup/clutch-star.webp" alt="clutch" width={269} height={89} className={styles.clutchImg} />
                            </div>

                            <div className={styles.partnerLogos}>
                                <Image src="/mvp-development/popup/featherDev.webp" alt="featherDev" width={151} height={37} />
                                <Image src="/mvp-development/popup/spherule.webp" alt="spherule" width={126} height={37} />
                                <Image src="/mvp-development/popup/globalBank.webp" alt="globalBank" width={151} height={37} />
                                <Image src="/mvp-development/popup/boltshift.webp" alt="boltshift" width={130} height={37} />
                            </div>
                        </div>
                    </div>
