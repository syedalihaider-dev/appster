                ...
                <Container>
                    <Row>
                        <Col xl={12} className={styles.york}>
                            ...
                            <p className='font16 font-normal white text-center'>Appsters is a Dubai-based mobile app development company that focuses on growth and innovation. We offer comprehensive services, from ideation to execution, aiming to accelerate business growth. With Dubai's thriving tourism and robust economy, we leverage this potential to create new revenue streams and foster long-term success. </p>
                            <p className='font16 font-normal white text-center'>With a growing client list, Appsters is committed to excellence and aims to create a catalyst for growth and prosperity in Dubai.</p>
                        </Col>
                            ...
                            {activeTab1 == 'tab1' &&
                                <div className={styles.newyork}>
                                    ...
                                    <Row className={`gy-5 ${styles.colpont}`}>
                                        <Col lg={6}>
                                            <h3 className={styles.stook}>Business Growth with Appsters: Your Trusted Mobile App Development Company</h3>
                                            <p>Build and scale your business with Appsters Mobile App Development Company. Our Dubai-based iOS and Android developers offer customized solutions for a robust mobile presence, ensuring quality, innovation, and exceptional user experiences.</p>
                                ...
                                <div className={styles.newyork}>
                                    ...
                                    <Row className={`gy-5 ${styles.colpont}`}>
                                        <Col lg={6}>
                                            ...
                                            <p>At Appsters, we empower businesses to reach their full potential with hybrid app development. Our app development company excels in creating and deploying apps across multiple platforms, ensuring seamless consistency and delivering top-notch user experiences. Do not limit your app's reach – choose hybrid app development for versatility, efficiency, and excellence.</p>
                                            <a className={styles.buld} href='javascript:window.replaceChat();'>Get In Touch With Our Experts</a>
                                        </Col>
                                        <Col lg={5}>
                                ...
                                <div className={styles.newyork}>
                                    <Row className={`gy-5 ${styles.colpont}`}>
                                        <Col lg={6}>
                                            ...
                                            <p>Appsters offers an Ecommerce app development service that combines digital marketing expertise with app development expertise to create visually appealing, functional apps that drive sales and conversions, enhancing user experience and revenue.</p>
                                            <a className={styles.buld} href='javascript:window.replaceChat();'>Get In Touch With Our Experts</a>
                                        </Col>
                                        <Col lg={5}>
                                ...
                                <div className={styles.newyork}>
                                    <Row className={`gy-5 ${styles.colpont}`}>
                                        <Col lg={6}>
                                            ...
                                            <p>Appsters focuses on putting people at the heart of business operations, developing B2B apps that streamline internal processes, foster efficient communication, and enhance collaboration. Our  human-centric approach empowers organizations to thrive in a competitive environment.</p>
                                            <a className={styles.buld} href='javascript:window.replaceChat();'>Get In Touch With Our Experts</a>
                                        </Col>
                                        <Col lg={5}>
