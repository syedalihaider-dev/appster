      ...
      <section className={styles.trandubai}>
        <Container>
          <Row className={`${styles.newtsl} gy-5`}>
            <Col lg={6}>
              <div>
                <h2 className="font40 white f-700">Appsters Transformative Impact
            ...
            <Col lg={6} className={`${styles.post} p-0`}>
              <Slider {...clientsthink} className={`${styles.clintSlider}`}>
                <div className={styles.shoot}>
                  <Image alt="Appsters" className='img-fluid' src={ship1} />
                  <h3>E-Commerce</h3>
                </div>
                <div className={styles.shoot}>
                  <Image alt="Appsters" className='img-fluid' src={ship2} />
                  <h3>Banking & Finance </h3>
                </div>
                <div className={styles.shoot}>
                  <Image alt="Appsters" className='img-fluid' src={ship3} />
                  <h3>Healthcare</h3>
                </div>
                <div className={styles.shoot}>
                  <Image alt="Appsters" className='img-fluid' src={ship2} />
