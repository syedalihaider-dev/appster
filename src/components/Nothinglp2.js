            ...
            <section className={styles[props.Nothing]}>
                <Container className='newfoldlp'>
                    <Row className='  align-items-center'>
                        ...
                        <Col lg={8}>
                            <Image src={banImg1} alt='Appsters' className='img-fluid' />
                        </Col>
                        <Col lg={4}>
                            <div>
                                <Slider {...bannerslider} className={` ${styles.startSlide} Serbannerslider`}>
                                    <div className={styles.strpImg}>
                                        <Image alt="Appsters" src={news1} className="img-fluid  " />
                                        <p className='white font12 mt-4 mb-1'>Appsters' development of the ProEYE project, a wallet analytics and search engine platform on blockchain, was exceptional. Their comprehensive work, from requirement analysis to deployment, resulted in a highly functional, user-friendly platform with advanced analytics and robust data integration. Their attention to detail in every phase ensured ProEYE's success in the blockchain arena.</p>
                                        <div className='d-flex align-items-center gap-2 my-1'>
                                            <h4 className='white font20 mb-0'>Joseph</h4>
                                            <Image src={verified} width={15} height={15} alt='Appsters' className={`img-fluid`} />
                                        </div>
                                        <p className='white font12'>CTO / Pronftdesign.com</p>
                                    </div>
                                    <div className={styles.strpImg}>
                                        <Image alt="Appsters" src={news2} className="img-fluid  " />
                                        <p className='white font12 mt-4 mb-1'>Appsters excelled in developing our custom CRM system, perfectly aligning it with our SEO firm's workflow. Their team delivered an efficient, user-friendly solution with impressive attention to detail. We highly recommend Appsters for their professionalism and app development expertise.</p>
                                        <div className='d-flex align-items-center gap-2 my-1'>
                                    ...
                                    <div className={styles.strpImg}>
                                        <Image alt="Appsters" src={news4} className="img-fluid  " />
                                        <p className='white font12 mt-4 mb-1'>We decided to hire app developers from Appsters on their hourly package and it turned out to be a perfect fit for our project's needs. Their team's expertise and efficiency were impressive, delivering high-quality work within our budget. The app they developed is exactly what we envisioned, both innovative and user-friendly.</p>
                                        <div className='d-flex align-items-center gap-2 my-1'>
                                    ...
                                    <div className={styles.strpImg}>
                                        <Image alt="Appsters" src={news5} className="img-fluid  " />
                                        <p className='white font12 mt-4 mb-1'>Working with Appsters was a game-changer for our retail chain. They developed an AI-assisted inventory management system that automates stock level tracking and predictive ordering. The accuracy and efficiency it brings to our supply chain management are phenomenal. It's a prime example of how AI can transform traditional retail operations.</p>
                                        <div className='d-flex align-items-center gap-2 my-1'>
                                ...
                                <div className='mt-5'>
                                    <a href="tel:8557991171" className={styles.btnpost}>Begin Your Success Story : Connect Now</a>
                                </div>
                            </div>
                        </Col>
