                        ...
                        <Col lg={12} className={styles.hover1}>
                            ...
                            <div className={` ${styles.client} sec_image text-center`}>
                                ...
                                <div onMouseEnter={() => fun1('active')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4> We're very satisfied with the results of our working relationship with Appsters. We were able to create a high-quality mobile app that not only met our specifications but exceeded them in every way. The entire team was friendly and professional throughout the entire process, and we would definitely recommend their services to anyone looking for a reliable custom app development company. <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active1')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>Appsters was a lifesaver for our business. We needed to create an app that could be used on multiple platforms, but we didn’t have a lot of technical know-how or additional development resources. Their team made it easy for us and delivered exactly what we needed. They stayed on top of our project and kept us informed throughout the process. We wouldn't hesitate to recommend them for any of your app development needs! <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active2')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>We hired mobile app developers to create a completely new mobile app for our company. The team at Appsters was really professional, efficient, and knowledgeable in the latest technologies and trends. We couldn't be happier with the results and will definitely be recommending them to anyone looking for top-notch mobile app development company. <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active3')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>Hiring Flutter app developers from Appsters was one of the best decisions I have ever made. They are highly skilled and knowledgeable professionals who understand customer needs and deliver well-crafted solutions to us. Overall, we are extremely satisfied with their service and highly recommend them to anyone looking for reliable and cost-effective Flutter solutions. <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active4')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>Appsters have done a great job making an attractive and eye-catching IOS application. I am grateful to the team for delivering this application perfectly on very short notice. Thanks a lot. <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active5')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>The rider app developed by Appsters transformed our ride-hailing service. The UI/UX is unmatched and our users love it! <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active6')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>Our company's data visualization took a leap forward with the BI app from Appsters. Accurate analytics and sleek presentation! <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active7')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>Making informed business decisions is easier than ever with the BI app from Appsters. Data visualization at its best! <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active8')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>he social media app developed by Appsters stands out in a crowded market. Fresh features and a user-centric approach! <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active9')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"Appsters's blockchain development app has revolutionized our financial transactions. Secure, fast, and reliable!" <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active10')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"Kudos to Appsters for creating a groundbreaking social media platform. The features are unique, and the design is sleek." <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active11')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"As a fitness enthusiast, I've tried countless apps. The fitness app by Appsters is by far the best – intuitive, comprehensive, and motivating." <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active12')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"As a personal trainer, the fitness app by Appsters is my go-to for clients. Its features and user experience are unparalleled." <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active13')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"The social media app developed by Appsters stands out in a crowded market. Fresh features and a user-centric approach!" <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                    <h5 className='mt-4'>Natasha Z.</h5>
                                </div>
                                ...
                                <div onMouseEnter={() => fun1('active14')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"Our enterprise needed a robust BI solution, and Appsters delivered! It's transformed the way we view our business metrics." <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active15')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>I run a cab service, and the rider app from Appsters has boosted our user engagement tremendously. It's a game-changer <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active16')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>I've been blown away by Appsters's commitment to quality. The blockchain development app is top-notch and user-friendly <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active17')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"Ever since our company ventured into blockchain technology, Appsters has been our trusted partner in mobile app development. The interface is seamless and the features robust!" <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active18')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"I've been searching for a top-tier social media app and Appsters delivered! User-friendly and innovative. Highly recommended." <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active19')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"The fitness app is a daily companion in my health journey. Kudos to Appsters for such an impeccable design and features." <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
                                ...
                                <div onMouseEnter={() => fun1('active20')}
                                    ...
                                    <Image src={comma} width={30} height={30} alt='Appsters' className='img-fluid' />
                                    <h4>"The rider app has made my daily commute so much easier. Booking a ride has never been more efficient. Thank you, Appsters!" <Image src={comma} alt='Appsters' className='img-fluid' /></h4>
